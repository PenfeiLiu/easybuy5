...
<div id="position" class="wrap">
	您现在的位置：<a href="/action">易买网</a> &gt; <a href="product-list.jsp">图书音像</a> &gt; 图书
</div>
		...
		<div class="product-list">
			...
			<ul class="product clearfix">
				<c:forEach var="pro" items="${productList}">
					<li>
						<dl>
							<dt><a href="/action4?id=${pro.ep_id}&action=detail" target="_blank"><img src="images/product/0_tiny.gif" /></a></dt>
							<dd class="title"><a href="/action4?id=${pro.ep_id}&action=detail" target="_blank">${pro.ep_name}</a></dd>
