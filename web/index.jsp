...
<div id="main" class="wrap">
	<div class="lefter">
		<div class="box">
			<h2>商品分类</h2>
			<dl>
				<c:forEach  var="directory" varStatus="status" items="${directoryList}">
				<c:if test="${directory.epcParentId==0}"	>
					<dt>${directory.epcName}</dt>
				</c:if>
	...
	<div class="main">
		...
		<div class="hot">
			<h2>热卖推荐</h2>
			<ul class="product clearfix">
				<c:forEach var="hotProductList" varStatus="status" items="${hotProductList}">
					<li>
						<dl>
